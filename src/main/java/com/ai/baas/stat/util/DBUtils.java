...
public class DBUtils {
    ...
    public static StatConfig loadStatConfig(String tenantId, String serviceType) throws SQLException {
        PreparedStatement ps = connection.prepareStatement(LOAD_STAT_CONFIG_BY_TENANTID_AND_SERIVCETYPE);
    ...
    public static StatResultItem loadStatResult(String tableName, List<String> statFields, Map<String, String> groupFieldValueMapping) throws SQLException {
        StatResultItem result = null;
        PreparedStatement ps = connection.prepareStatement(generateStatResultSQL(tableName, statFields, groupFieldValueMapping.keySet()));
        int index = 1;
